...
if(isset($_POST["btnsub"]))
{
    ...
    $obj=new clsfet();
    $obj->fetdsc=$_POST["txtcty"];
    
    if(isset($_SESSION["ccod"]))
    {
        $obj->fetcod=$_SESSION["ccod"];
        $obj->update_Rec();
        unset($_SESSION["ccod"]);
    }
    else
    ...
    <section id="about">
      <div class="container">
         ...
         <header class="section-header">
          <h3>Feature</h3>
          <form name="f1" action="frmfet.php" method="post" onsubmit="return validate_register()">
                  </header>
    <div class="col-md-6  cty-frm    form-line">
                        <div class="form-group">
                            <label for="exampleInputUsername">Feature Desc</label>
            ...
            <?php
                                       ...
                                       // print_r($arr);
                                        if(count($arr)>0)
                                        {
                                            ...
                                            echo "<tr><th>Sr No</th><th>Feature</th><th></th></tr>";
                                            for($i=0;$i<count($arr);$i++)
                                            {
                                                ...
                                                echo "<td>".$arr[$i][1]."</td>";
                                                echo "<td class=button-right><a  class=edit-btn href=frmfet.php?ccod=".$arr[$i][0]."&mode=E>Edit</a>";
                                                echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
                                                echo "<a class=delete-btn href=frmfet.php?ccod=".$arr[$i][0]."&mode=D>Delete</a></td></tr>";
                                            }
                                        }
                                        echo '</table>';
                                        ?>
