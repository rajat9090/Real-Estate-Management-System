    ...
    <section id="about">
      <div class="container">
         ...
         <header class="section-header">
          <h3>Cities</h3>
          <form name="f1" action="frmcty.php" method="post" onsubmit="return validate_register()">
                  </header>
            ...
            <?php
                                       ...
                                       // print_r($arr);
                                        if(count($arr)>0)
                                        {
                                            ...
                                            echo "<tr><th>Sr No</th><th>City</th><th></th></tr>";
                                            for($i=0;$i<count($arr);$i++)
                                            {
                                                ...
                                                echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
                                                echo "<a class=delete-btn href=frmcty.php?ccod=".$arr[$i][0]."&mode=D>Delete</a></td></tr>";
                                            }
                                        }
                                        echo '</table>';
                                        ?>
